...
export const App: React.FC = () => {
  ...
  const firstVisibleItem = items.indexOf(visibleItems[0]) + 1;
  const lastVisibleItem = (firstVisibleItem + itemsPerPage - 1) > items.length
    ? items.length
    : firstVisibleItem + itemsPerPage - 1;
