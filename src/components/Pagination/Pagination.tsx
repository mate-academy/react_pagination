...
const getNumberOfElement = (
  currentPage: number,
  perPage: number,
  total: number,
): number[] => {
  const elementOnPage: number[] = [];
...
export const Pagination: React.FC<Props> = ({
  ...
  const elementsOnPages = getNumberOfElement(currentPage, perPage, total);
