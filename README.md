[DEMO LINK](https://artemvlasiuk.github.io/react_pagination/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artemvlasiuk.github.io/react_pagination/) and add it to the PR description.
