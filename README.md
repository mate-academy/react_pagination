...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://AnastasiiaKriuchkova.github.io/react_pagination/) and add it to the PR description.
