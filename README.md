...
1. The `Pagination` should be used with the next props:
    ...
    />
    ```
1. Keep the HTML structure `data-cy` attributes;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://AnOvramenko.github.io/react_pagination/) and add it to the PR description.
