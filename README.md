...
- Use the [React TypeScript cheat sheet](https:git//mate-academy.github.io/fe-program/js/extra/react-typescript).
- Open one more terminal and run tests with `npm test` to ensure your solution is correct.
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://YevhenProtasov.github.io/react_pagination/) and add it to the PR description.
