...
You have a given list of items and markup for the `Pagination`. Implement the
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://fatihsamur.github.io/react_pagination/) and add it to the PR description.
